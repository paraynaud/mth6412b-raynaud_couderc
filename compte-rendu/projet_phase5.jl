...
md" # Projet Phase n°5, Raynaud Paul, Couderc Romain."
...
md" Le code de cette phase est dans la branche phase-5-merge." 
...
md" On forme explicitement le tour sous forme de liste d'entier, on calcule son coût puis on l'écrit à l'aide de la fonction write\_tour. Ensuite il ne reste plus qu'à construire l'image obtenue à partir de la fonction reconstruct\_picture."
...
# ╔═╡ ac80eb60-3e83-11eb-2416-b961c6248c14
md" On a procédé de la même manière avec HK" 

# ╔═╡ bc622a7e-3e83-11eb-11ed-d3721422db9e
display("C:\\Users\\raynaudp\\Documents\\Poly\\cours\\MTH6412B\\code\\git_tmp\\mth6412b-raynaud_couderc\\reconstruct_pictures.jl", 94, 114)

# ╔═╡ ce7abc00-3e83-11eb-1ee7-8dd0b03c7f2b
display("C:\\Users\\raynaudp\\Documents\\Poly\\cours\\MTH6412B\\code\\git_tmp\\mth6412b-raynaud_couderc\\reconstruct_pictures.jl", 114, 129)
...
md" Toutes les images sont dans l'ordre suivant: Original, RSL, HK. Notre HK n'est pas complètement abouti, c'est pour quoi il ne donne pas les meilleurs résultats"
